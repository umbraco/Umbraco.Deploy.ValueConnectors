    ...
    public class ArchetypeValueConnector : IValueConnector
    {
        ...
        public void SetValue(IContentBase content, string alias, string value)
        {
            ...
            foreach (var archetypeProperty in properties)
            {
                ...
                // Code below is disabled (but enabled in Deploy!) because PropertyCollection is an Umbraco internal class - left in here to make the example complete
                ...
                /*
                    ...
                    var mockContent = new Content("mockContent", -1, new ContentType(-1), new PropertyCollection() { mockProperty });
